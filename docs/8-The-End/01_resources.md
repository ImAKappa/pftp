...
Not sure, what to make with Python? You can find lots of [Python projects](https://github.com/search?q=python&type=repositories&s=stars&o=desc) on GitHub,
...
1. Google what I am trying to do, like [this](https://www.google.com/search?q=how+to+sort+a+list+in+python)
2. Look through a popular forum called StackOverflow, especially if it's a more complicated problem (like [this](https://stackoverflow.com/questions/231767/what-does-the-yield-keyword-do-in-python))

    - Alternatively, you can google your programming question, then add the word "StackOverflow" to your search query, like [this](https://www.google.com/search?q=what+does+yield+do+python+stackoverflow)

3. Peruse the official [Python documentation](https://docs.python.org/3/)
...
5. Ask an AI assistant. Language models are pretty good, and fairly accurate, for basic programming questions.

!!! info "StackOverflow"

    There's a [running joke](https://youtube.com/shorts/qol2X_8JF9I?feature=share) that a software developer's job is just copy-pasting answers off of StackOverflow
...
1. [Python in a 100 seconds](https://www.youtube.com/watch?v=x7X9w_GIm1s)
...
2. [Corey Schafer's entire YouTube channel](https://www.youtube.com/@coreyms)

    - You can start [here](https://www.youtube.com/playlist?list=PL-osiE80TeTt2d9bfVyTiXJA-UTHn6WwU) 
...
4. [mCoding's entire YouTube channel](https://www.youtube.com/@mCoding)

    - You can start [here](https://www.youtube.com/watch?v=E8NijUYfyus)
...
1. [Think Python](https://greenteapress.com/thinkpython2/html/index.html)
...
3. [Composing Programs](https://composingprograms.com/)
...
Generally I find it can be overwhelming to mention _too_ many resources, so I'll stop there.

## 🎓 Beyond Python

Learn more languages! I highly recommend trying out [JavaScript](https://developer.mozilla.org/en-US/docs/Web/JavaScript) next, and the first place I would start is Daniel Shiffman's wonderful YouTube channel [The Coding Train](https://www.youtube.com/@TheCodingTrain/featured).

He taught me not only the details of programming, but how to have fun with it.
His enthusiasm is absolutely infectious and I sincerely hope you check out his work.