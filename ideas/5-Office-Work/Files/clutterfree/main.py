...
def file_category(file: Path) -> FileCategory:
    ...
    if extension in ("webm", "mov", "mp4", "avi"):
        return FileCategory.VIDEO
    if extension in ("py", "js", "txt", "json", "csv", "html", "css"):
        return FileCategory.TEXT
    if extension in ("bmp", "png", "jpeg", "tiff", "jpg", "gif"):
        return FileCategory.IMAGE
    if file.is_dir() or extension in ("zip"):
